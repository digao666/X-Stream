...
@app.route('/google/loggedinstate')
def logged_in_state():
    resp = make_response(json.dumps(is_logged_in()))
    return resp
...
def google_auth_redirect():
    ...
    if req_state == None or req_state != flask.session[AUTH_STATE_KEY]:
    ...
    return flask.redirect('http://localhost', code=302)
